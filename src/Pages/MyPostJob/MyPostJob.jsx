...
const MyPostJob = () => {
    ...
    return (
      ...
      <div className='flex items-center gap-x-3'>
        ...
        <span className='px-3 py-1 text-xs text-violet-700 bg-violet-200 rounded-full '>
          {jobs.length} Job
        </span>
      </div>
          ...
          <div className='inline-block min-w-full py-2 align-middle md:px-6 lg:px-8'>
            <div className='overflow-hidden border border-gray-200  md:rounded-lg'>
              <table className='min-w-full divide-y divide-gray-200'>
                ...
                <tbody className='bg-violet-50 divide-y divide-gray-200 '>
                  {
                    jobs.map(job => 
                        <tr key={job._id}>
                    ...
                    <td className='px-4 py-4 text-sm whitespace-nowrap'>
                      <div className='flex items-center gap-x-6'>
                        <button onClick={()=> handelDeleteJOb(job._id)} className='text-red-500 transition-colors duration-200   hover:text-red-400  focus:outline-none'>
                          <svg
